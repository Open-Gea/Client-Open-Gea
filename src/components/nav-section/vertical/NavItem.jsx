...
export function NavItemSub({ item, open = false, active = false, onOpen }) {
  ...
  const renderContent = (
    <>
      <Iconify icon={'fluent-emoji-high-contrast:diamond-with-a-dot'} color={active ? palette.primary.ligth : palette.primary.disabled} />
...
export function ArrowIcon({ open }) {
  return (
    <Iconify icon={open ? 'mdi:arrow-down-drop-circle-outline' : 'mdi:arrow-right-drop-circle'} sx={{ width: 16, height: 16, ml: 1 }} />
  );
}

...
// actions
import { setFilteredFarms, handleRequestSort } from '../../../../../redux/slices/farmsCooperativa';
...
export default function UserListHead({ rowCount }) {
  ...
  const { order, orderBy, countries, filteredFamrs } = useSelector(s => s.farmsCooperativaSlice);

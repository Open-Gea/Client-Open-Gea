...
// actions
import { handleRequestSort } from '../../../../../redux/slices/requestsCooperativa';
...
export default function RequestsListHead({ rowCount }) {
  ...
  const { order, orderBy, filterName } = useSelector(s => s.requestsCooperativaSlice);
        ...
        {headLabel(t).map(headCell => (
          ...
          >
            <TableSortLabel
              ...
              disabled={filterName === '' ? headCell.id === 'state' || headCell.id === 'actions' || headCell.id === 'bodyMessage'|| headCell.id === 'name'  : headCell.id === 'state'  || headCell.id === 'actions'  || headCell.id === 'bodyMessage'|| headCell.id === 'name' || headCell.id === 'createdAt'  }
            >
              {headCell.label}
              {orderBy === headCell.id ? (

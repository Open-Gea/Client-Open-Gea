...
export default function MapViewDialog({ lat, lng, name, owner, country }) {
  ...
  const openGoogleEarth = () =>{
    const googleEarthUrl = `https://earth.google.com/web/@${lat},${lng},4.1766631a,885.15242684d,35y,-0h,0t,0r/data=CgoSBEgSJChkYXRhOgYKICgweDNkOTJkMjY0YTAwOWI5OmZjbDl3b2t5YWN1OTVhd2VoZWcYASAB`;
    ...
    <div>
      ...
      >
        ...
        <DialogActions sx={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <Button variant="outlined" onClick={openGoogleEarth}>
          <LocationOnIcon />
            Google Earth
          </Button>
          <Button variant="outlined" onClick={handleClose}>{tCommon('close')}</Button>
        </DialogActions>
      </Dialog>
    </div>
  );

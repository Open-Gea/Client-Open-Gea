...
import AddEditLabor from './AddEditStaffInfo';

// ----------------------------------------------------------------------

export default function StaffInfoMoreMenu({ onDelete, editInfo }) {
  const [open, setOpen] = useState(false);
  const [openDialog, setOpenDialog] = useState(false);
  const { bioInputs } = useSelector(s => s.recordsSlice);

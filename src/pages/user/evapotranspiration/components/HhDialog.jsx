...
import { setHhResults } from '../../../../redux/slices/evotranspiracion';
...
export default function HhDialog() {
  ...
  const { hhResults } = useSelector(s => s.evotranspiracionSlice);
  ...
  return (
    <>
      ...
      >
        <DialogTitle>{t('footprintDialogResult.title')} </DialogTitle>
        <DialogContent>
          <Stack direction="row" spacing={4}>
            <Stack>
              <Typography variant="subtitle" sx={{ pl: 1 }} color="text.secondary">
                <b> {t('footprintDialogResult.footTotal')} </b>
              </Typography>
              <Typography variant="subtitle" sx={{ pl: 1 }} color="text.secondary">
                <b> {t('footprintDialogResult.footGreen')} </b>
              </Typography>
              <Typography variant="subtitle" sx={{ pl: 1 }} color="text.secondary">
                <b> {t('footprintDialogResult.footBlue')}</b>
              </Typography>
            </Stack>
            <Stack>
              <Typography variant="subtitle" sx={{ pl: 1 }} color="text.secondary">

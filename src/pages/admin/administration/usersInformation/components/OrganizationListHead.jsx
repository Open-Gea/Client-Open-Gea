...
OrganizationListHead.propTypes = {
  rowCount: PropTypes.number,
};
const headLabel = (t) => [
  { id: 'status', label: t('usersTable.statusHeader'), alignRight: false },
  { id: 'name', label: t('usersTable.nameHeader'), alignRight: false },
...
export default function OrganizationListHead({ rowCount }) {
        ...
        {headLabel(t).map(headCell => (
          ...
          >
            <TableSortLabel
              ...
              disabled={filterName === '' ? headCell.id === 'status' ||  headCell.id === 'registrationDate' || headCell.id === 'country' || headCell.id === 'email' || headCell.id === 'actions' : headCell.id === 'status' || headCell.id === 'name' ||  headCell.id === 'registrationDate' ||  headCell.id === 'country' || headCell.id === 'email' || headCell.id === 'actions' }
            >
              {headCell.label}
              {orderBy === headCell.id ? (
